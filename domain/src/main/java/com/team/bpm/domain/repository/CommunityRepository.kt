...
interface CommunityRepository {
    ...
    suspend fun sendCommunityReport(communityId: Int, reason: String): Flow<Unit>
    ...
    suspend fun sendCommunityCommentReport(communityId: Int, commentId: Int, reason: String): Flow<Unit>
