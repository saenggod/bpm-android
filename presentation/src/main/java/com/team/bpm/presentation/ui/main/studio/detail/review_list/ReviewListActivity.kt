package com.team.bpm.presentation.ui.main.studio.detail.review_list
                    ...
                    itemsIndexed(
                        ...
                        ReviewComposable(
                            ...
                            onClickLike = { reviewId -> event.invoke(
                                ReviewListContract.Event.OnClickReviewLike(
                                    reviewId
                                )
                            ) },
                            onClickActionButton = { event.invoke(
                                ReviewListContract.Event.OnClickReviewActionButton(
                                    review,
                                    index
                                )
                            ) }
                ...
                if (isReportDialogShowing) {
                    ...
                    TextFieldDialog(
                        ...
                        onClickConfirm = { reason -> event.invoke(
                            ReviewListContract.Event.OnClickSendReviewReport(
                                reason
                            )
                        ) }
                    )
